...
/*   Updated: 2024/05/06 12:21:31 by peferrei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*int	main(void)
{
	char str3[50] = "bbbbbbbbbbbbbbbbbbbbbbbbbb";
	char str4[50] = "ASAdassdasd";
	
	int r = ft_strlcpy(str3, str4, 5);
...
int		main(int argc, const char *argv[])
{
	...
	{
		ft_print_result(ft_strlcpy(dest, "lorem", 10));
		write(1, "\n", 1);
		write(1, "So this is it: ", 15);
